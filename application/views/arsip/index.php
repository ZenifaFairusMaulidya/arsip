...
<div class="row mt-3">
	<div class="col-md-6">
		<a href="<?php echo base_url(); ?>arsip/tambah" class="btn btn-primary">Tambah Arsip Surat</a>
	</div>
</div>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
            	<table id="dataTable" class="table table-bordered table-striped table-hover js-basic-example dataTable display" border="1">
        <thead>
            <tr>
              <th>No</th>
              <th>Asal Surat</th>
