<h3>Data Arsip Surat Pengadaan</h3>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $query = mysqli_query($koneksi,"SELECT * FROM surat_masuk WHERE perihal LIKE '%Pengadaan%'");
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-action">
                                                <div class="hidden-phone visible-desktop action-buttons">
                                                    <a class="green" href="preview_surat_pengadaan.php?id=<?php echo $data['id_surat'];?>">
